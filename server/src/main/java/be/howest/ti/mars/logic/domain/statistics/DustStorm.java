...
public class DustStorm implements Statistics{
    ...
    public DustStorm(int id, int domeId, DamageLevel damageLevel, String date, Double longitude, Double latitude, Dome dome) {
        this.id = id;
        this.domeId = domeId;
